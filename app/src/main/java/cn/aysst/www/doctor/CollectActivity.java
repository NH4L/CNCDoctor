...
import cn.aysst.www.doctor.fragment.FragmentHistory;
...
public class CollectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_cnc_collect);
        adapter = new MyHistoryAdapter(this);
        initMyHistory();
        //设置LayoutManager为LinearLayoutManager
        layoutManager = new LinearLayoutManager(this);

        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swip_refresh_on_collect);
    ...
    private void refreshTask() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                refreshMyHistory();
                new CollectActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(CollectActivity.this, "刷新成功", Toast.LENGTH_SHORT).show();
